...
var map = {
	"./auth/auth.module": [
		...
		"default~auth-auth-module~auth-rearrange-rearrange-module~auth-set-password-set-password-module~auth-~c5e70d05",
		"common",
		"auth-auth-module"
	],
	...
	"./auth/rearrange/rearrange.module": [
		"./src/app/auth/rearrange/rearrange.module.ts",
		"default~auth-auth-module~auth-rearrange-rearrange-module~auth-set-password-set-password-module~auth-~c5e70d05",
		"common",
		"auth-rearrange-rearrange-module"
	],
	"./auth/set-password/set-password.module": [
	...
	"./transaction-details/transaction-details.module": [
	...
	"./wallet-details/wallet-details.module": [
		"./src/app/wallet/wallet-details/wallet-details.module.ts",
		"default~auth-auth-module~auth-rearrange-rearrange-module~auth-set-password-set-password-module~auth-~c5e70d05",
		"common",
		"wallet-details-wallet-details-module"
	],
	"./wallet/wallet-details/info/info.module": [
...
var routes = [
    ...
    { path: 'wallet', loadChildren: './wallet/wallet.module#WalletPageModule', canLoad: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, auth, route) {
...
var Transaction = /** @class */ (function () {
    function Transaction(id, name, from, to, imageUrl, amount, hash, status) {
        this.id = id;
        this.name = name;
        this.from = from;
        this.to = to;
...
var User = /** @class */ (function () {
    function User(id, mnemonic, password, wallets, Transactions) {
        this.id = id;
...
var Wallet = /** @class */ (function () {
    function Wallet(id, Name, address, privateKey, description, imageUrl, balance) {
        this.id = id;
        this.Name = Name;
...
/* harmony import */ var _models_wallet_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../models/wallet.model */ "./src/app/models/wallet.model.ts");
/* harmony import */ var _models_transaction_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../models/transaction.model */ "./src/app/models/transaction.model.ts");
...
var AuthService = /** @class */ (function () {
    function AuthService(storage) {
        ...
        this.users = [
            new _models_user_model__WEBPACK_IMPORTED_MODULE_2__["User"](0, 'hello world world', 'password', [
                new _models_wallet_model__WEBPACK_IMPORTED_MODULE_3__["Wallet"](0, 'Ethereum', '0x501938d5c17442C9a54B522021702101d9415D14', 'FB7DC2E493FD50D5B8ED13FDB4902954CC1CCD3D890669F81AE088CDB2043ACD', 'your most used cryptocurrency', 
                // tslint:disable-next-line: max-line-length
                'https://s.yimg.com/ny/api/res/1.2/79GZvpsBiB0w.4UMxQEijw--~A/YXBwaWQ9aGlnaGxhbmRlcjtzbT0xO3c9ODAw/http://media.zenfs.com/en-US/homerun/coin_rivet_596/45607ac1ecdfb82f720db97b79887702', 979),
                new _models_wallet_model__WEBPACK_IMPORTED_MODULE_3__["Wallet"](1, 'Bit Coin', '', '', 'The most popular cryptocurreny', 'https://www.theblockcrypto.com/wp-content/uploads/2019/05/bitcoin-buy-1-1200x675.jpg', 1500),
                new _models_wallet_model__WEBPACK_IMPORTED_MODULE_3__["Wallet"](2, 'lite coin', '', '', 'Cool place near charminar', 
                // tslint:disable-next-line: max-line-length
                'https://static.coindesk.com/wp-content/uploads/2014/02/Litecoin-logo-e1517247177826.png', 150)
            ], [
                new _models_transaction_model__WEBPACK_IMPORTED_MODULE_4__["Transaction"](0, 'ethereum', '234543', '23454342', 
                // tslint:disable-next-line: max-line-length
                'https://lh4.googleusercontent.com/njmacjXG5DhDcvSpCy6xd584sMRXIwoFxXliEZitBH4OqvK4IT_Zfi6DOuUQcsZNBeURhMtJoBhpLiiTqq6HL3yWmV9Kbpeq0LNbtxLANgAoYfk8rzJMsBYrzSKfTxyQp5Fw499f', 78, '', 'completed'),
                new _models_transaction_model__WEBPACK_IMPORTED_MODULE_4__["Transaction"](1, 'litecoin', '234543', '23454342', 
                // tslint:disable-next-line: max-line-length
                'https://lh4.googleusercontent.com/njmacjXG5DhDcvSpCy6xd584sMRXIwoFxXliEZitBH4OqvK4IT_Zfi6DOuUQcsZNBeURhMtJoBhpLiiTqq6HL3yWmV9Kbpeq0LNbtxLANgAoYfk8rzJMsBYrzSKfTxyQp5Fw499f', 56, '', 'completed'),
                new _models_transaction_model__WEBPACK_IMPORTED_MODULE_4__["Transaction"](2, 'blockchain', '234543', '23454342', 
                // tslint:disable-next-line: max-line-length
                'https://lh4.googleusercontent.com/njmacjXG5DhDcvSpCy6xd584sMRXIwoFxXliEZitBH4OqvK4IT_Zfi6DOuUQcsZNBeURhMtJoBhpLiiTqq6HL3yWmV9Kbpeq0LNbtxLANgAoYfk8rzJMsBYrzSKfTxyQp5Fw499f', 78, '', 'completed'),
                new _models_transaction_model__WEBPACK_IMPORTED_MODULE_4__["Transaction"](3, 'ethereum', '234543', '23454342', 
                // tslint:disable-next-line: max-line-length
                'https://lh4.googleusercontent.com/njmacjXG5DhDcvSpCy6xd584sMRXIwoFxXliEZitBH4OqvK4IT_Zfi6DOuUQcsZNBeURhMtJoBhpLiiTqq6HL3yWmV9Kbpeq0LNbtxLANgAoYfk8rzJMsBYrzSKfTxyQp5Fw499f', 88, '', 'completed')
            ])
        ];
        this.presentUser = this.users[0];
        this.userIsAuthenticated = false;
        storage.set('presentUser', this.presentUser);
        storage.get('presentUser').then(function (val) {
            _this.presentUser = val;
            console.log(val);
        });
    }
...
module.exports = __webpack_require__(/*! /Users/anurag/Work/anurag/digiwallet/src/main.ts */"./src/main.ts");
